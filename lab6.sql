...
ALTER table Movie
    ADD check (year>1900);--7

Alter table Rating
    add check(stars = 1 OR stars=2 OR stars=3 OR stars=4 OR stars=5 );--8

Alter table Rating
    add check(ratingDate>'2000-01-01');--9

alter table movie
    add check(case when director='Steven Spielberg' then year<1900
                   when director='James Cameron' then year>1990 end ); --10
